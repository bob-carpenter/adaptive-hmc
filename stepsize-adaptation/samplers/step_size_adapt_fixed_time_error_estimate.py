...
class NUTS_local_adapt(vn.FixedStepSizeNUTS):
    def __init__(self,
                 model,
                 rng,
                 theta,
    ...
    def compute_acceptance_probability(self, current_position_adapted_step_size,
        ...
        log_likelihood_from_proposal = proposal_position_adapted_step_size.step_size_log_likelihood(
            log_proposed_step_size)
        log_likelihood_from_current = current_position_adapted_step_size.step_size_log_likelihood(
            log_proposed_step_size)
