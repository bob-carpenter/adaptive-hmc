...
np.save(f"{results_directory}/num_halvings_{num_chains}_chains_{num_samples}_samples_dimension_{dimension}.npy", num_halvings)
np.save(f"{results_directory}/step_sizes_{num_chains}_chains_{num_samples}_samples_dimension_{dimension}.npy", step_sizes)
