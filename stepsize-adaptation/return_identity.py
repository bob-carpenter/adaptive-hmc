...
#Validation for B' transform computed from initial point and from sample in NUTSOrbit
...
nuts_orbit_from_sample = nuts.NUTSOrbit(sampler, rng, sample._theta, sample._rho, step_size, number_fine_grid_steps,
                                        sample._bernoulli_sequence)

print(
    f"Left endpoint and momentum as computed from initial point: theta = {nuts_orbit._orbit_root._left_theta}, rho = {nuts_orbit._orbit_root._left_rho}\n")
print(
    f"Left endpoint as computed from sample: theta = {nuts_orbit_from_sample._orbit_root._left_theta}, rho = {nuts_orbit_from_sample._orbit_root._left_rho}\n")
print(
    f"Right endpoint and momentum as computed from initial point: theta = {nuts_orbit._orbit_root._right_theta}, rho = {nuts_orbit._orbit_root._right_rho}\n")
print(
    f"Right endpoint as computed from sample: theta = {nuts_orbit_from_sample._orbit_root._right_theta}, rho = {nuts_orbit_from_sample._orbit_root._right_rho}\n")

print(
    f"Left endpoints equal = {np.allclose(nuts_orbit._orbit_root._left_theta, nuts_orbit_from_sample._orbit_root._left_theta)}")
print(
    f"Right endpoints equal = {np.allclose(nuts_orbit._orbit_root._right_theta, nuts_orbit_from_sample._orbit_root._right_theta)}")
print(
    f"Left momenta equal = {np.allclose(nuts_orbit._orbit_root._left_rho, nuts_orbit_from_sample._orbit_root._left_rho)}")
print(
    f"Right momenta equal = {np.allclose(nuts_orbit._orbit_root._right_rho, nuts_orbit_from_sample._orbit_root._right_rho)}")
...
print(
    f"Energy max the same = {np.allclose(nuts_orbit._orbit_root._energy_max, nuts_orbit_from_sample._orbit_root._energy_max)}")
print(
    f"Energy min the same = {np.allclose(nuts_orbit._orbit_root._energy_min, nuts_orbit_from_sample._orbit_root._energy_min)}")
