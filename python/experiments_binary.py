...
from algorithms import HMC_Adaptive_Binary
import util
...
if args.pfactor != 1.:
    savefolder = f"{savefolder}"[:-1] + f"-pfactor{args.pfactor:d}/"
if args.pthresh != 0.:
    savefolder = f"{savefolder}"[:-1] + f"-pthresh{args.pthresh:0.2f}/"
if args.suffix != "":
